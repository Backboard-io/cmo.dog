...
output "ecr_push_commands" {
  ...
  value = [
    ...
    "docker buildx build --platform linux/amd64 -f docker/dockerfile.dev -t onni .",
    "docker tag onni:latest ${module.ecr.repository_url}:${var.environment}-${var.ecr_image_tag}",
